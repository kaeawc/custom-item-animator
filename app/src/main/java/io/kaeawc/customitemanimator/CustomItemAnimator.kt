...
open class CustomItemAnimator : SimpleItemAnimator() {
    ...
    internal class MoveInfo(var holder: RecyclerView.ViewHolder, var fromX: Int, var fromY: Int, var toX: Int, var toY: Int)

    internal class ChangeInfo(var oldHolder: RecyclerView.ViewHolder?, var newHolder: RecyclerView.ViewHolder?) {
        var fromX: Int = 0
        var fromY: Int = 0
        var toX: Int = 0
        var toY: Int = 0
    ...
    override fun runPendingAnimations() {
        ...
        if (changesPending) {
            ...
            if (removalsPending) {
                ...
                if (itemView != null) ViewCompat.postOnAnimationDelayed(itemView, changer, removeDuration)
                else changer.run()
            } else {
                changer.run()
            }
